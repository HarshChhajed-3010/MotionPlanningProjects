...
def main():
    ...
    parser.add_argument('--environment', type=str, default='environment_1.txt', help='Name of the obstacles file')
    parser.add_argument('--path', type=str, default='path1.txt', help='Name of the path file') 
